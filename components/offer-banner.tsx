...
export const OfferBanner = () => {
  ...
  return (
    <motion.section
      ...
      initial="hidden"
      animate="visible"
      className="mx-5 sm:mx-10 m-5 bg-gradient-to-r from-[#1b6f5f] to-[#2EC5A7] p-4 sm:p-5 rounded-lg flex flex-col md:flex-row justify-between items-center text-white"
    >
